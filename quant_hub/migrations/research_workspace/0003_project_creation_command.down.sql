...
RENAME TO research_workspace_command_receipt_with_project_creation;
...
-- If project-create receipts already exist this copy fails atomically instead
-- of silently deleting audit history during a downgrade.
...
SELECT
    receipt_id,idempotency_key,command_name,payload_hash,
    outcome_json,http_status,created_at
FROM research_workspace_command_receipt_with_project_creation;

DROP TABLE research_workspace_command_receipt_with_project_creation;
